...
export default function Footer() {
  return (
    <footer className="bg-linen border-t border-ink/10 text-ink py-16 px-6 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-12 gap-x-8 gap-y-12 relative z-10">
        ...
        {/* Links */}
        <div className="col-span-1 md:col-span-2 flex flex-col items-start md:items-start text-left">
        ...
        {/* Conserje Atelier */}
        <div className="col-span-2 md:col-span-4 bg-softBeige/50 border border-burgundy/10 p-6 md:p-8 rounded-xl flex flex-col items-center text-center">
