...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full bg-base border-t border-ink/10 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-[60] flex items-center justify-around pb-safe">
      <Link 
        href="/coleccion" 
      ...
      >
        ...
        <span className="text-[10px] font-sans font-bold uppercase tracking-widest">Tienda</span>
      </Link>
